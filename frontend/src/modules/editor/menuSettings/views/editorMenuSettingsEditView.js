...
define(function(require) {
  ...
  var MenuSettingsCollection = require('modules/editor/menuSettings/collections/editorMenuSettingsCollection');
  var MenuSettingsView = require('modules/editor/menuSettings/views/editorMenuSettingsView');
