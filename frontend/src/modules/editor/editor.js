...
define(function(require) {
  ...
  var EditorRouter = require('modules/editor/global/editorRouter');
  var EditorCollection = require('modules/editor/global/collections/editorCollection');
  ...
  var EditorComponentTypeModel = require('modules/editor/page/models/editorComponentTypeModel');
  var ExtensionModel = require('modules/editor/extensions/models/extensionModel');
  var EditorCourseAssetModel = require('modules/editor/course/models/editorCourseAssetModel');
  var EditorClipboardModel = require('modules/editor/global/models/editorClipboardModel');
