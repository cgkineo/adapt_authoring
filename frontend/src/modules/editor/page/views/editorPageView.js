...
define(function(require){
  ...
  var EditorArticleView = require('modules/editor/page/views/editorArticleView');
  var EditorArticleModel = require('modules/editor/page/models/editorArticleModel');
  var EditorPasteZoneView = require('modules/editor/global/views/editorPasteZoneView');
