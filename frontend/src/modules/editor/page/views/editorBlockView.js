...
define(function(require){
  ...
  var EditorComponentView = require('modules/editor/page/views/editorComponentView');
  var EditorComponentPasteZoneView = require('modules/editor/page/views/editorComponentPasteZoneView');
