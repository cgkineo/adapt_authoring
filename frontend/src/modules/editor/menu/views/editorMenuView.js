...
define(function(require){
  ...
  var EditorMenuLayerView = require('modules/editor/menu/views/editorMenuLayerView');
  var EditorMenuItemView = require('modules/editor/menu/views/editorMenuItemView');
