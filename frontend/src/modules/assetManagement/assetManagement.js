...
define(function(require) {
  ...
  var CourseModel = require('modules/editor/course/models/editorCourseModel');
  var CourseAssetModel = require('modules/editor/course/models/editorCourseAssetModel');
  var ProjectCollection = require('core/collections/projectCollection');
